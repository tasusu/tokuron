...
\begin{frame}[allowframebreaks]
    ...
    \begin{enumerate}
        ...
        \item \textbf{(11/6) 二部マッチング②（最短路問題の復習，逐次最短路法と主双対法，最適性基準からの見方）}
        \item[] \alert{(11/13) 休み}
        \item[] \textcolor{gray}{(11/20) 休み}
        \item[] \textcolor{gray}{(11/27) 休み}
        \item (12/4) 最大流① （定式化，最大流最小カット定理，Mengerの定理，Hakimiの定理，密グラフ抽出）
        \item (12/11) 最大流②（残余ネットワーク，Ford-Fulkerson法，容量スケーリング法）
